  ...
  return (
    <div className="relative grid h-dvh flex-col items-center justify-center px-8 sm:px-0 lg:max-w-none lg:grid-cols-2 lg:px-0">
      <div className="bg-muted relative hidden h-full flex-col p-10 text-white lg:flex dark:border-r">
        ...
        <Link href={route('login')} className="relative z-20 flex items-center gap-5 text-lg font-medium">
          <img src="/images/plp-1.png" alt="Pamantasan ng Lungsod ng Pasig Logo" className="size-10 scale-150" />
        ...
        <span className="z-40 mt-4 text-xs font-medium uppercase">QMS Version: {version}</span>
      </div>
